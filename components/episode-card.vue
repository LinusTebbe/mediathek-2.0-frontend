        ...
        <div class="card-footerContainer">
            <div class="card-footer">
                ...
                <div class="button-area">
                    ...
                    <button @click="startDownload" v-else-if="!episode.is_downloaded" key="download">
                        <font-awesome-icon icon="download"/>
                    </button>
                    <button @click="deleteCache" v-else-if="episode.is_downloaded" key="delete">
    ...
    export default {
        ...
        methods: {
            startDownload: async function () {
                ...
                const inMemoryResponse = new Response(video.data, {headers: video.headers});
